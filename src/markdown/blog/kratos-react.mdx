...
If you want to use your own Ory Kratos instance, you can use the `ORY_KRATOS_URL`
...
You may also run Ory Kratos in a local environment. A quick way to begin is to run the
...
In that case, set the environment variable `ORY_SDK_URL` to your local Ory Kratos instance:
